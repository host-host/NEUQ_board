(function (global, factory) {
  ...
  if(!window.location.href.includes('neuq')){
  ...
  (function($) {
      ...
      var webFullscreenBtn = $('#js-webfullscreen');
      webFullscreenBtn.on('click', function (e) {
          e.preventDefault();
          $(document.body).toggleClass('is-webfullscreen');
