...
(function(n) {
    ...
    function r() {
        ...
        return "requestFullscreen"in n || "mozRequestFullScreen"in n && document.mozFullScreenEnabled || "webkitRequestFullScreen"in n
    }
    function u(n) {
    ...
    function f(t) {
        n(document).on("fullscreenchange mozfullscreenchange webkitfullscreenchange", function() {
            t(i())
        })
    }
    n.support.fullscreen = r();
    n.fn.fullScreen = function(r) {
        if (!n.support.fullscreen || this.length !== 1)
            return this;
        if (i())
            return t(),
            this;
        ...
        }).insertBefore(e).append(e);
        return e.addClass(o.fullscreenClass),
        u(s.get(0)),
        s.click(function(n) {
            n.target == this && t()
        }),
        ...
        ,
        f(function(t) {
            t || (n(document).off("fullscreenchange mozfullscreenchange webkitfullscreenchange"),
            e.removeClass(o.fullscreenClass).insertBefore(s),
            s.remove());
    ...
    ;
    n.fn.cancelFullScreen = function() {
        return t(),
        this
    }
}
